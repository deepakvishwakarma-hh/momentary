...
import { Button, Flex, Grid, Input, Select, Text, Tooltip, Modal, ModalOverlay, ModalContent, ModalHeader, ModalFooter, ModalBody, ModalCloseButton, useDisclosure } from "@chakra-ui/react";
...
const Index = () => {
    ...
    // Joining Room Handlersss
    const [joinToken, setJoinToken] = useState<string>('');

    const onJoinHandler = () => {
        const link = `/room/${joinToken}`
        router.push(link)
    }
    const onJoinTokenHandler = (e: any) => {
                    ...
                    <Modal onClose={onClose} isOpen={isOpen} isCentered>
                        ...
                        <ModalContent bg={'blackAlpha.800'}>
                            ...
                            <ModalBody>
                                ...
                                <Flex my={2} color={'white'} flexDir={'column'}>
                                    <Text fontSize={20} color="tomato">Join</Text>
                                    <Flex border={'1px grey solid'} borderRadius={5}>
                                        <Input onChange={onJoinTokenHandler} border={'none'} flex={3} placeholder="Enter key to join" />
                                        <Button onClick={onJoinHandler} borderLeft={'1px grey solid'} borderRadius={0} variant={'black'} flex={1} >
                                ...
                                <Text mt={4} fontSize={20} color="tomato">Setup</Text>

                                {/* <Text opacity={.8} color="white">Select option to terminate your room automatically. otherwise 5 minute by default.</Text> */}
                                <Flex border={'1px grey solid'} borderRadius={5}>
                                    <Select flex={3} borderRadius={0} _focus={{ color: 'black' }}
                                        onChange={onChangeHandler} variant='filled' placeholder='termination'>
